...
class DatabaseAuto{
    companion object {
        ...
        fun insertarAuto(auto: Auto){
            "http://192.168.100.28:1337/Auto".httpPost(listOf("chasis" to auto.chasis, "nombre" to auto.nombre, "nombreModelo" to auto.nombreModelo, "precio" to auto.precio, "color" to auto.color,"anio" to auto.anio,"imagenAuto" to auto.imagenAuto,"conductorId" to auto.conductorId ))
        ...
        fun eliminarAuto(id: Int) {
            "http://192.168.100.28:1337/Auto/$id".httpDelete()
        ...
        fun actualizaAuto(auto: Auto) {
            "http://192.168.100.28:1337/Auto/${auto.id}".httpPut(listOf("chasis" to auto.chasis, "nombre" to auto.nombre, "nombreModelo" to auto.nombreModelo, "precio" to auto.precio, "color" to auto.color, "anio" to auto.anio))
                    .responseString { request, _, result ->
                        Log.d("http-ejemplo", request.toString())
                    }
        }
        ...
        fun getAutoList(conductorId: Int): ArrayList<Auto> {
            ...
            val (request, response, result) = "http://192.168.100.28:1337/Auto?conductorId=$conductorId".httpGet().responseString()
