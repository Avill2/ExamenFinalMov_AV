...
class DatabaseConductor{
    ...
    companion object {
        ...
        fun insertarConductor(conductor: Conductor){
            "http://192.168.100.28:1337/Conductor".httpPost(listOf("nombre" to conductor.nombre, "apellido" to conductor.apellido, "fechaNacimiento" to conductor.fechaNacimiento, "numeroAutos" to conductor.numeroAutos, "licenciaValida" to conductor.licenciaValida))
        ...
        fun eliminarConductor(id: Int) {
            "http://192.168.100.28:1337/Conductor/$id".httpDelete()
        ...
        fun actualizaConductor(conductor: Conductor) {
            "http://192.168.100.28:1337/Conductor/${conductor.id}".httpPut(listOf("nombre" to conductor.nombre, "apellido" to conductor.apellido, "fechaNacimiento" to conductor.fechaNacimiento, "numeroAutos" to conductor.numeroAutos, "licenciaValida" to conductor.licenciaValida))
                    .responseString { request, _, result ->
                        Log.d("http-ejemplo", request.toString())
                    }
        }
        ...
        fun getList(): ArrayList<Conductor> {
            ...
            val (request, response, result) = "http://192.168.100.28:1337/Conductor".httpGet().responseString()
